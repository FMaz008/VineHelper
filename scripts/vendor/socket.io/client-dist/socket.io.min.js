...
!(function (t, n) {
	...
	var O,
		...
		C = function (t, n) {
			return "blob" === n ? (t instanceof Blob ? t : new Blob([t])) : t instanceof ArrayBuffer ? t : t.buffer;
		},
		...
		return new TransformStream({
			transform: function (t, n) {
				!(function (t, n) {
					...
					(t.data && "string" != typeof t.data && (r[0] |= 128), n.enqueue(r), n.enqueue(i));
				});
			},
		});
	}
	...
	((I.prototype.on = I.prototype.addEventListener =
		function (t, n) {
			return ((this.t = this.t || {}), (this.t["$" + t] = this.t["$" + t] || []).push(n), this);
		}),
		...
		(I.prototype.emit = function (t) {
			this.t = this.t || {};
			for (var n = new Array(arguments.length - 1), i = this.t["$" + t], r = 1; r < arguments.length; r++)
				n[r - 1] = arguments[r];
			if (i) {
				r = 0;
	...
	var R =
		...
		L = "undefined" != typeof self ? self : "undefined" != typeof window ? window : Function("return this")();
	function _(t) {
	...
	function $(t, n) {
		n.useNativeTimers
			...
			: ((t.setTimeoutFn = L.setTimeout.bind(L)), (t.clearTimeoutFn = L.clearTimeout.bind(L)));
	}
	function F() {
			...
			return (
				...
				(i.u = function (t) {
					var n = (function (t) {
						...
						for (var i in t)
							t.hasOwnProperty(i) &&
								(n.length && (n += "&"), (n += encodeURIComponent(i) + "=" + encodeURIComponent(t[i])));
						return n;
					})(t);
					return n.length ? "?" + n : "";
				}),
			...
			return (
				...
				(r.onData = function (t) {
					...
					((function (t, n) {
						...
						if (("opening" === n.readyState && "open" === t.type && n.onOpen(), "close" === t.type))
							return (n.onClose({ description: "transport closed by the server" }), !1);
						n.onPacket(t);
					}),
						"closed" !== this.readyState &&
							((this.h = !1), this.emitReserved("pollComplete"), "open" === this.readyState && this.v()));
				}),
				(r.doClose = function () {
					var t = this,
						n = function () {
			...
			function n(n) {
				...
				if (((i = t.call(this, n) || this), "undefined" != typeof location)) {
					var r = "https:" === location.protocol,
						e = location.port;
					(e || (e = r ? "443" : "80"),
						(i.xd = ("undefined" != typeof location && n.hostname !== location.hostname) || e !== n.port));
				}
				return i;
			}
			s(n, t);
		...
		Y = (function (t) {
			...
			return (
				(i.A = function () {
					...
					"undefined" != typeof document && ((this.S = n.requestsCount++), (n.requests[this.S] = this));
				}),
				(i.B = function (t) {
				...
				(i.O = function () {
					...
					null !== t && (this.emitReserved("data", t), this.emitReserved("success"), this.N());
				}),
				(i.abort = function () {
					this.N();
				}),
				...
				(r.addEventListeners = function () {
					...
					((this.ws.onopen = function () {
						...
						(this.ws.onclose = function (n) {
							return t.onClose({ description: "websocket connection closed", context: n });
						}),
	...
	function ft(t) {
		...
		var n = t,
			i = t.indexOf("["),
			r = t.indexOf("]");
		-1 != i && -1 != r && (t = t.substring(0, i) + t.substring(i, r).replace(/:/g, ";") + t.substring(r, t.length));
	...
	var ct = "function" == typeof addEventListener && "function" == typeof removeEventListener,
		at = [];
	ct &&
		addEventListener(
			"offline",
	...
	var vt = (function (t) {
		function n(n, i) {
			...
			return (
				$(r, i),
				(r.secure =
					null != i.secure ? i.secure : "undefined" != typeof location && "https:" === location.protocol),
				...
				if ("opening" === this.readyState || "open" === this.readyState || "closing" === this.readyState)
					switch ((this.emitReserved("packet", t), this.emitReserved("heartbeat"), t.type)) {
						case "open":
							...
							break;
						case "ping":
							(this.J("pong"), this.emitReserved("ping"), this.emitReserved("pong"), this.K());
							break;
						case "error":
	...
	var lt = (function (t) {
			...
			return (
				...
				(i.nt = function (t) {
					for (var n = [], i = 0; i < t.length; i++) ~this.transports.indexOf(t[i]) && n.push(t[i]);
					return n;
				}),
				n
			);
	...
	var dt = "function" == typeof ArrayBuffer,
		...
		wt = "function" == typeof Blob || ("undefined" != typeof Blob && "[object BlobConstructor]" === bt.call(Blob)),
		gt = "function" == typeof File || ("undefined" != typeof File && "[object FileConstructor]" === bt.call(File));
	function mt(t) {
		return (dt && (t instanceof ArrayBuffer || yt(t))) || (wt && t instanceof Blob) || (gt && t instanceof File);
	}
	function kt(t, n) {
		...
		if (mt(t)) return !0;
		if (t.toJSON && "function" == typeof t.toJSON && 1 === arguments.length) return kt(t.toJSON(), !0);
		for (var e in t) if (Object.prototype.hasOwnProperty.call(t, e) && kt(t[e])) return !0;
		return !1;
	}
	function At(t) {
		var n = [],
	...
	function Ot(t, n) {
		...
		else if ("object" === c(t)) for (var r in t) Object.prototype.hasOwnProperty.call(t, r) && (t[r] = Ot(t[r], n));
		return t;
	}
	var Bt,
	...
	var Nt = (function () {
			...
			return (
				...
				(n.encodeAsString = function (t) {
					var n = "" + t.type;
					return (
						(t.type !== Bt.BINARY_EVENT && t.type !== Bt.BINARY_ACK) || (n += t.attachments + "-"),
						t.nsp && "/" !== t.nsp && (n += t.nsp + ","),
						null != t.id && (n += t.id),
				...
				(i.add = function (n) {
					...
					if ("string" == typeof n) {
						...
						(i = this.reconstructor.takeBinaryData(n)) &&
							((this.reconstructor = null), t.prototype.emitReserved.call(this, "decoded", i));
					}
				}),
				...
				(n.isPayloadValid = function (t, n) {
					switch (t) {
						...
						case Bt.BINARY_EVENT:
							return (
								Array.isArray(n) &&
								("number" == typeof n[0] || ("string" == typeof n[0] && -1 === St.indexOf(n[0])))
							);
						case Bt.ACK:
						case Bt.BINARY_ACK:
		...
		Lt = (function (t) {
			...
			return (
				...
				(o.connect = function () {
					return (
						this.connected ||
							(this.subEvents(), this.io.ot || this.io.open(), "open" === this.io.st && this.onopen()),
						this
					);
				}),
				(o.open = function () {
				...
				(o.emit = function (t) {
					var n, i, r;
					if (Rt.hasOwnProperty(t)) throw new Error('"' + t.toString() + '" is a reserved event name');
					for (var e = arguments.length, o = new Array(e > 1 ? e - 1 : 0), s = 1; s < e; s++)
						o[s - 1] = arguments[s];
					if ((o.unshift(t), this.l.retries && !this.flags.fromQueue && !this.flags.volatile))
						return (this.ut(o), this);
					var u = { type: Bt.EVENT, data: o, options: {} };
					if (((u.options.compress = !1 !== this.flags.compress), "function" == typeof o[o.length - 1])) {
						var h = this.ids++,
							f = o.pop();
						(this.ht(h, f), (u.id = h));
					}
					var c =
							null === (i = null === (n = this.io.engine) || void 0 === n ? void 0 : n.transport) ||
							void 0 === i
								? void 0
								: i.writable,
						a = this.connected && !(null === (r = this.io.engine) || void 0 === r ? void 0 : r.W());
					return (
						(this.flags.volatile && !c) ||
							(a ? (this.notifyOutgoingListeners(u), this.packet(u)) : this.sendBuffer.push(u)),
						(this.flags = {}),
						this
					);
				}),
				...
				(o.emitWithAck = function (t) {
					for (var n = this, i = arguments.length, r = new Array(i > 1 ? i - 1 : 0), e = 1; e < i; e++)
						r[e - 1] = arguments[e];
				...
				(o.ut = function (t) {
					...
					(t.push(function (t) {
						if (r === i.it[0]) {
							if (null !== t) r.tryCount > i.l.retries && (i.it.shift(), n && n(t));
				...
				(o.vt = function (t) {
					this.packet({ type: Bt.CONNECT, data: this.lt ? e({ pid: this.lt, offset: this.dt }, t) : t });
				}),
				(o.onerror = function (t) {
					this.connected || this.emitReserved("connect_error", t);
				}),
				(o.onclose = function (t, n) {
					((this.connected = !1), delete this.id, this.emitReserved("disconnect", t, n), this.yt());
				}),
				(o.yt = function () {
					var t = this;
					Object.keys(this.acks).forEach(function (n) {
						if (
							...
							var i = t.acks[n];
							(delete t.acks[n], i.withError && i.call(t, new Error("socket has been disconnected")));
						}
					});
				}),
				...
				(o.emitEvent = function (n) {
					...
					(t.prototype.emit.apply(this, n),
						this.lt && n.length && "string" == typeof n[n.length - 1] && (this.dt = n[n.length - 1]));
				}),
				(o.ack = function (t) {
					var n = this,
						i = !1;
				...
				(o.offAny = function (t) {
					...
					if (t) {
						for (var n = this.bt, i = 0; i < n.length; i++) if (t === n[i]) return (n.splice(i, 1), this);
					} else this.bt = [];
					return this;
				}),
				...
				(o.offAnyOutgoing = function (t) {
					...
					if (t) {
						for (var n = this.gt, i = 0; i < n.length; i++) if (t === n[i]) return (n.splice(i, 1), this);
					} else this.gt = [];
					return this;
				}),
	...
	var Dt = (function (t) {
			function n(n, i) {
				...
				(((r = t.call(this) || this).nsps = {}),
					...
					r.randomizationFactor(null !== (e = i.randomizationFactor) && void 0 !== e ? e : 0.5),
					(r.backoff = new _t({
			...
			return (
				(i.reconnection = function (t) {
					return arguments.length ? ((this.kt = !!t), t || (this.skipReconnect = !0), this) : this.kt;
				}),
				...
				(i.reconnectionDelay = function (t) {
					...
					return void 0 === t
						? this.jt
						: ((this.jt = t), null === (n = this.backoff) || void 0 === n || n.setMin(t), this);
				}),
				(i.randomizationFactor = function (t) {
					var n;
					return void 0 === t
						? this.Et
						: ((this.Et = t), null === (n = this.backoff) || void 0 === n || n.setJitter(t), this);
				}),
				(i.reconnectionDelayMax = function (t) {
					var n;
					return void 0 === t
						? this.Ot
						: ((this.Ot = t), null === (n = this.backoff) || void 0 === n || n.setMax(t), this);
				}),
				...
				(i.socket = function (t, n) {
					var i = this.nsps[t];
					return (
						i ? this.et && !i.active && i.connect() : ((i = new Lt(this, t, n)), (this.nsps[t] = i)),
						i
					);
				}),
				(i.wt = function (t) {
				...
				(i.ct = function (t) {
					for (var n = this.encoder.encode(t), i = 0; i < n.length; i++) this.engine.write(n[i], t.options);
				}),
				(i.cleanup = function () {
					(this.subs.forEach(function (t) {
						return t();
				...
				(i.St = function () {
					((this.skipReconnect = !0), (this.ot = !1), this.onclose("forced close"));
				}),
				...
				(i.reconnect = function () {
					...
					if (this.backoff.attempts >= this.At)
						(this.backoff.reset(), this.emitReserved("reconnect_failed"), (this.ot = !1));
					else {
						...
						var r = this.setTimeoutFn(function () {
							n.skipReconnect ||
								...
								n.skipReconnect ||
									n.open(function (i) {
										i
											? ((n.ot = !1), n.reconnect(), t.emitReserved("reconnect_error", i))
											: n.onreconnect();
									}));
						}, i);
				...
				(i.onreconnect = function () {
					...
					((this.ot = !1), this.backoff.reset(), this.emitReserved("reconnect", t));
				}),
				n
			);
		})(I),
		...
		var i,
			r = (function (t) {
				...
				return (
					...
					(r.href = r.protocol + "://" + e + (i && i.port === r.port ? "" : ":" + r.port)),
					r
				);
