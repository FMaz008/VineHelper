...
!(function (e, t) {
	"object" == typeof exports && "undefined" != typeof module
		...
		: "function" == typeof define && define.amd
			? define(t)
			: ((e = "undefined" != typeof globalThis ? globalThis : e || self)["@kurkle/color"] = t());
})(this, function () {
	"use strict";
	function e(e) {
		return (e + 0.5) | 0;
	...
	function p(e, t, f) {
		const r = h(e, 1, 0.5);
		let n;
		for (t + f > 1 && ((n = 1 / (t + f)), (t *= n), (f *= n)), n = 0; n < 3; n++)
			((r[n] *= 1 - t - f), (r[n] += t));
		return r;
	}
	function m(e) {
	...
	function _(e) {
		...
		const i = w(+t[2]),
			...
			c = +t[4] / 100;
		return (
			(n = "hwb" === t[1] ? v(i, s, c) : "hsv" === t[1] ? x(i, s, c) : Y(i, s, c)),
			{ r: n[0], g: n[1], b: n[2], a: a }
		);
	}
	function F(e, t) {
		var f = m(e);
	...
	function P(e) {
		...
		if (r) {
			...
			return (
				...
				(a = +r[3]),
				(i = +r[5]),
				(n = 255 & (r[2] ? f(n) : t(n, 0, 255))),
				(a = 255 & (r[4] ? f(a) : t(a, 0, 255))),
				(i = 255 & (r[6] ? f(i) : t(i, 0, 255))),
				{ r: n, g: a, b: i, a: s }
			);
		}
	}
	...
	function R(e, t, f) {
		if (e) {
			let r = m(e);
			((r[t] = Math.max(0, Math.min(r[t] + r[t] * f, 0 === t ? 360 : 1))),
				(r = Y(r)),
				(e.r = r[0]),
				(e.g = r[1]),
				(e.b = r[2]));
	...
	function U(e) {
		...
		return (
			Array.isArray(e)
				? e.length >= 3 && ((t = { r: e[0], g: e[1], b: e[2], a: 255 }), e.length > 3 && (t.a = r(e[3])))
				: ((t = A(e, { r: 0, g: 0, b: 0, a: 1 })).a = r(t.a)),
			t
		);
	}
	class V {
		constructor(e) {
			...
			("object" === t
				? (f = U(e))
				: "string" === t && (f = o(e) || S(e) || ("r" === (r = e).charAt(0) ? P(r) : _(r))),
				(this._rgb = f),
				(this._valid = !!f));
		}
		get valid() {
		...
		mix(e, t) {
			if (e) {
				...
				((n = 1 - c),
					(f.r = 255 & (c * f.r + n * r.r + 0.5)),
					(f.g = 255 & (c * f.g + n * r.g + 0.5)),
					(f.b = 255 & (c * f.b + n * r.b + 0.5)),
					(f.a = a * f.a + (1 - a) * r.a),
					(this.rgb = f));
			}
			return this;
