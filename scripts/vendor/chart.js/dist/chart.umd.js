...
!(function (t, e) {
	...
	function pt(t, e, i) {
		...
		if (t._sorted) {
			...
			(d && (n = J(Math.min(it(r, l, h).lo, i ? s : it(e, l, a.getPixelForValue(h)).lo), 0, s - 1)),
				(o = u
					? J(
							Math.max(it(r, a.axis, c, !0).hi + 1, i ? 0 : it(e, l, a.getPixelForValue(c), !0).hi + 1),
							n,
							s
						) - n
					: s - n));
		...
		return Fi(
			...
			(function (t, e, i, s) {
				...
				for (a = e + 1; a <= i; ++a) {
					...
					(i.skip || i.stop
						? l.skip ||
							((s = !1), o.push({ start: e % n, end: (a - 1) % n, loop: s }), (e = r = i.stop ? a : null))
						: ((r = a), l.skip && (e = a)),
						(l = i));
				}
	...
	class Ns {
		...
		buildOrUpdateElements(t) {
			...
			((e._stacked = Es(e.vScale, e)),
				...
				(s || n !== e._stacked) && (zs(this, e._parsed), (e._stacked = Es(e.vScale, e))));
		}
		configure() {
	...
	function xn(t, e, i) {
		...
		let o = s.get(n);
		if (!o) {
			((o = { resolver: je(e, i), subPrefixes: i.filter((t) => !t.toLowerCase().includes("hover")) }),
				s.set(n, o));
		}
		return o;
	}
			...
			updateElements(t, e, i, n) {
				...
				for (let i = 0; i < _; ++i) {
					...
					const v = this.getParsed(i),
						...
						k = (_[f] =
							o || M ? r.getBasePixel() : r.getPixelForValue(l ? this.applyStack(r, v, l) : v[f], i));
			...
			updateElements(t, e, i, n) {
				...
				for (let c = e; c < e + i; ++c) {
					const e = t[c],
						...
						M = (p[g] =
							o || y ? r.getBasePixel() : r.getPixelForValue(l ? this.applyStack(r, i, l) : i[g], c));
	...
	class Va extends Hs {
		...
		setActiveElements(t, e) {
			...
			(n || o) &&
				((this._active = s), (this._eventPosition = e), (this._ignoreReplayEvents = !0), this.update(!0));
		}
		handleEvent(t, e, i = !0) {
